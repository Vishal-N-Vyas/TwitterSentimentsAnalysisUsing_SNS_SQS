...
public class SimpleQueueServiceSample {
	...
	public static String rawQueueURL = "KEY";
	public static String processedQueueURL = "KEY";
	public static String topicARN = "KEY";
    public static String processedQueueARN = "KEY"; 
    public static String subscriptionARN = "KEY";
